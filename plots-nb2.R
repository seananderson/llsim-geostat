...
# f <- "/Users/seananderson/Library/CloudStorage/Box-Box/LLSim/For comparison with spatial/Output All 5 percent/Blue marlin bycatch/"

# d <- readr::read_csv(paste0(f, "Blue marlinbycatchDataSummary.csv"))
# load("/Users/seananderson/Library/CloudStorage/Box-Box/LLSim/For comparison with spatial/Output All 5 percent/sumdatR")
# # glimpse(d)
# yearSum |> str()
#
# load("/Users/seananderson/Library/CloudStorage/Box-Box/LLSim/For comparison with spatial/Coverage5Percent.r")
