...
files_base <- paste0(fleet, params$species, "-", files_base, "-", knots)
...
index_file <- here::here("data-generated", paste0(fleet, params$species, "-", "index.rds"))
...
temp |>
  ...
  geom_line() +
  geom_line(data = true |> select(-model), lty = 2, colour = "black", inherit.aes = FALSE, mapping = aes(year, est)) +
  gg_scales +
  gg_labs +
