...
- coverage seems a bit low but not too bad
...
We will then use the `update()` method to refit our model with two additional families: delta-Gamma and delta-lognormal.
...
We also estimated larger spatial ranges than   spatiotemporal arranges (sold vs. dotted lines) and broader spatial correlation in the binomial model but broader spatiotemporal correlation in the positive model (green vs. orange ellipses).
